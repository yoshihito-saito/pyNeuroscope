...
pyNeuroscope is a Python desktop app for inspecting NeuroScope-style electrophysiology recordings and creating NeuroSuite / Neurocode-compatible `amplifier.xml` files.
